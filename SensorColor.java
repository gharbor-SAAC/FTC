 ...
 */
@TeleOp(name = "SensorColor.java", group = "Sensor")
...
public class SensorColor extends LinearOpMode {
   ...
   * to have a clear hue) before falling through to hue-based buckets. The hue
   * boundaries below are generic starting points - tune them against your own
   * calibration readings (see conversation history) if a specific object is landing
   * in the wrong bucket.
   */
